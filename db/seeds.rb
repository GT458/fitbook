...
User.create(email: 'demo1@demo.com', password: 'password', fname: 'Demo', lname: 'User', birthday:'01-01-1999', gender: 'Male', profile_photo_url: '', cover_photo_url: '', school: '', bio: '', work: '', city: '')
